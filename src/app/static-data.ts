export class StaticData {
  ...
  public static readonly COMMENT_WITH_USER_DATA = 258828;
  public static readonly BUGZILLA_LINK = 'https://bugzilla.onlyoffice.com';

  public static readonly PRODUCTS =
    {
      'Office Canvas Document Editor':
      {
        id: 1,
        name: 'Documents',
        color: '#cbcbff',
        active: false,
        realName: 'Office Canvas Document Editor'
      },
      'Office Canvas Spreadsheet Editor':
      {
        ...
        color: '#c5ffc5',
        active: false,
        realName: 'Office Canvas Spreadsheet Editor'
      },
      'Office Canvas Presentation Editor':
      {
        id: 4,
        name: 'Presentations',
        color: '#ffa7a7',
      ...
      'documenteditors plugins':
      {
        id: 7,
        name: 'Plugins',
        color: '#ff8ee2',
        active: false,
        realName: 'Document Editors Plugins'
      },
      DocumentBuilder:
      {
        id: 8,
  ...
  public static readonly STATUSES =
    {
      NEW: {
        id: 1,
        name: 'New/Assigned/Reopen',
        realName: 'NEW',
        addition: ['ASSIGNED', 'REOPENED'],
        active: false,
        nextStatus: ['FIXED', 'INVALID', 'WANTFIX']
      },
      RESOLVED:
      {
        id: 2,
